      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={wearwayWallpaper}
              isBlog={false}
              title="WearWay Ecommerce"
              description="A modern, responsive e-commerce platform for men, women, and kids fashion. Built with React, Vite, and TailwindCSS, featuring product filtering, cart and checkout flows, search, wishlist support, and dark/light mode."
              ghLink="https://github.com/WEARWAY2/WearWay"
              demoLink="https://final-project-delta-self.vercel.app/"
              technologies={["React", "Vite", "TailwindCSS", "JavaScript", "E-commerce", "Responsive Design"]}
              featured={true}
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={cardWallpaper}
              isBlog={false}
              title="Institution - Goodwill Foundation"
              description="A bilingual Arabic and English foundation website built with Next.js 14, TypeScript, TailwindCSS, and Framer Motion. It includes full RTL support, SEO optimization, a responsive layout, WhatsApp contact access, and Google Maps integration."
              ghLink="https://github.com/ZiaddAshraf/institution"
              demoLink="https://institution-gamma.vercel.app"
              technologies={["Next.js", "TypeScript", "TailwindCSS", "Framer Motion", "RTL", "SEO"]}
              featured={true}
            />
          </Col>
